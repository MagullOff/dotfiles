...
-- essa
maps.n["j"] = {"h", desc="move"}
maps.n["k"] = {"j", desc="move"}
maps.n["l"] = {"k", desc="move"}
maps.n[";"] = {"l", desc="move"}
maps.v["j"] = {"h", desc="move"}
maps.v["k"] = {"j", desc="move"}
maps.v["l"] = {"k", desc="move"}
maps.v[";"] = {"l", desc="move"}
-- Packer
...
if is_available "smart-splits.nvim" then
  ...
  maps.n["<leader>j"] = { function() require("smart-splits").move_cursor_left() end, desc = "Move to left split" }
  maps.n["<leader>k"] = { function() require("smart-splits").move_cursor_down() end, desc = "Move to below split" }
  maps.n["<leader>l"] = { function() require("smart-splits").move_cursor_up() end, desc = "Move to above split" }
  maps.n["<leader>;"] = { function() require("smart-splits").move_cursor_right() end, desc = "Move to right split" }
  ...
  maps.n["<leader>j"] = { "<C-w>h", desc = "Move to left split" }
  maps.n["<leader>k"] = { "<C-w>j", desc = "Move to below split" }
  maps.n["<leader>l"] = { "<C-w>k", desc = "Move to above split" }
  maps.n["<leader>;"] = { "<C-w>l", desc = "Move to right split" }
...
maps.t["<C-j>"] = { "<c-\\><c-n><c-w>h", desc = "Terminal left window navigation" }
maps.t["<C-k>"] = { "<c-\\><c-n><c-w>j", desc = "Terminal down window navigation" }
maps.t["<C-l>"] = { "<c-\\><c-n><c-w>k", desc = "Terminal up window navigation" }
maps.t["<C-;>"] = { "<c-\\><c-n><c-w>l", desc = "Terminal right window navigation" }
